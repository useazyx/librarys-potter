...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="overflow-hidden bg-ruled py-24 lg:py-32" aria-labelledby="saga-title">
        <div ref={storyRef} className="mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-2 lg:px-10">
          <div className="relative">
            ...
            <motion.div
              ...
              className="absolute -bottom-8 -right-2 hidden rounded-2xl bg-burgundy-600 px-8 py-6 text-center text-parchment-50 shadow-book sm:block"
            >
              <p className="font-display text-4xl leading-none text-gold-300">450mi</p>
          ...
          <div ref={revealRef}>
            ...
            <h2 id="saga-title" className="text-balance font-display text-4xl text-parchment-50 sm:text-5xl" data-reveal>
              Tudo começou com uma carta entregue por uma coruja
            </h2>

            <p className="mt-6 leading-relaxed text-parchment-200/80" data-reveal>
            ...
            <p className="mt-4 leading-relaxed text-parchment-200/80" data-reveal>
            ...
            {PROMISES.map((promise, index) => {
              ...
              return (
                <motion.article
                  ...
                  className="rounded-2xl border border-parchment-100/10 bg-night-800/60 p-7"
                >
                  <Icon size={26} className="mb-5 text-gold-400" aria-hidden />
                  <h3 className="font-display text-lg text-parchment-50">{promise.title}</h3>
                  <p className="mt-3 text-sm leading-relaxed text-parchment-200/70">{promise.text}</p>
                </motion.article>
              )
            })}
          </div>
      ...
      <section className="relative overflow-hidden py-28" aria-labelledby="cta-title">
        <img
          ...
          loading="lazy"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-night-900 via-night-900/80 to-night-900/40" aria-hidden />
        ...
        >
          ...
          <h2 id="cta-title" className="text-balance font-display text-4xl text-parchment-50 sm:text-5xl">
            Crie sua conta e comece a coleção
          </h2>

          <p className="mx-auto mt-6 max-w-xl text-parchment-200/80">
            Guarde seus pedidos, avalie o que já leu e fale com o suporte sem sair do site.
          </p>

          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <ButtonLink to="/cadastro" size="lg" variant="gold">
              Criar minha conta
            </ButtonLink>
            <ButtonLink
              to="/catalogo"
