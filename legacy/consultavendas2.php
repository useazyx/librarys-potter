...
<head>
    ...
    <link rel="stylesheet" href="consultavendas2.css"> <!-- Link para o CSS -->
</head>
...
<body>
    <div class="wrapper">
        ...
        <form method="post" action="">
            <div class="input-box">
                <input type="text" id="cv" name="cv" placeholder="Digite o Código da Venda" required>
            </div>
            <div class="btn-group">
        ...
        <a href="consultavendas.php" class="back-link">Voltar</a>
    </div>
</body>
